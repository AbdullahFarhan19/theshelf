...
public class MainActivity extends AppCompatActivity {
    ...
    @Override
    protected void onCreate(Bundle savedInstanceState) { // AppCompatActivity Gives Backwards Compatability For Previous Android Versions, AppCompatActivity Is A Subclass Of FragmentActivity Which Is A Subclass Of Activity Which Every Activity Must Inherit From
       ...
       //boolean hasSeen = preferences.getBoolean("seen_starting_screen", false); // Get The Boolean Value s_s_s From The Xml File, If It Doesn't Exist Consider It False, This Prevents The App From Crashing
        ...
        ((Button) findViewById(R.id.btn_next)).setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v){ // Needs to be onClick
